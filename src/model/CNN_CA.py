...
class CNN2D(nn.Module):
    def __init__(self, inplane, dropout=0.5, pooling_type='maxpool'):
        super().__init__()
...
if __name__ == '__main__':
    ...
    patch = 64
    pcnn = CNN_CA(2,1,32,'maxpool',num_layers=1,patch_size=(patch,patch),slide_window=(patch*patch,patch*patch/2))
    print(pcnn)
