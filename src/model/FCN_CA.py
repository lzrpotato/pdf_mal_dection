...
class FCN_CA(nn.Module):
    ...
    def forward(self, x):
        ...
        for i in x:
            ...
            v_attn_out, v_attn = self.v_attn(t_attn_out)
...
if __name__ == '__main__':
    ...
    patch = 64
    pcnn = FCN_CA(2,1,32,'maxpool',num_layers=1,patch_size=(patch,patch),slide_window=(patch*patch,patch*patch/2))
