...
logger = logging.getLogger('model.MSFCN1SH_CCA')

__all__ = ['MSFCN1SH_CCA']
...
def get_msfcn1cca_share(nclass=2, inplane=1, globalpool='maxpool', num_layers=1, patch_size=(256,256), slide_window=(256*256,256*256/2)):
    return MSFCN1_CCA(nclass, nc=inplane, globalpool=globalpool, num_layers=num_layers,
            multiscale='share', patch_size=patch_size, slide_window=slide_window)
...
if __name__ == '__main__':
    ...
    pcnn = get_msfcn1cca_share(2,1,'maxpool',num_layers=1,patch_size=(patch,patch),slide_window=(patch*patch,patch*patch/2))
